...
export class LibraryService {
  ...
  getBooksForAuthor(author_id:any){
  ...
  setFavoriteBook(data:any){
    let params = {
      "favorite_book": data
    }
    return this.http.post(`${this.urlServer}favorite_books`,params)
  }

  getCheckLikeBoot(user_id:any, book_id:any){
  return this.http.get(`${this.urlServer}check_favorite?user_id=${user_id}&book_id=${book_id}`)
  }

  likeBoot(user_id:any, book_id:any){
    let params = {
